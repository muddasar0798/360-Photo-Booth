      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h2>Contact</h2>
            <p>Get a quote on your email by submitting 
              below form or you can directly call or mail us on below mentioned contact and email address.</p>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row justify-content-center mt-4">
          ...
          <div class="col-lg-9">
          <form action="https://formspree.io/f/mqkokbkg" method="post" class="book_form">
            <!-- <form action="https://formspree.io/f/mqkokbkg" method="post" role="form" class="php-email-form"> -->
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="hrs" class="form-control" id="hrs" placeholder="Hours" required>
                </div>
                <!-- <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="toi" id="toi" placeholder="Event Type" required>
                </div> -->
